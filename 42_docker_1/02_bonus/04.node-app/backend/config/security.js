...
module.exports.security = {
  ...
  ***************************************************************************/
  ...
  cors: {
     allRoutes: true,
     allowOrigins: ['http://localhost:1338','http://172.33.0.4:8080',`http://${process.env.MACHINE_IP}:1338`],
     allowRequestHeaders: 'Host, Origin, Content-Type, Authorization, authorization, Accept',
